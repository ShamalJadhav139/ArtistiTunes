...
class MainActivityPresenter(private val mView: MainContract.View) : MainContract.Presenter {
    ...
    override fun onClick(
        ...
        val retrofitWeather = ApiClient.weatherClient
        ...
        when (caseConstants) {
            ApiConstants.artistiTunes -> {
                accessTokenCall = weatherRequestInterface.artistiTunes(para[0])
                callApiWithAccessToken(accessTokenCall, context, ApiConstants.artistiTunes)
            }
        }
    }
